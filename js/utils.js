function change_language(lan) {
    ...
    try {
        map.setLayoutProperty('road-label', 'text-field', '{name_' + language + '}');
        map.setLayoutProperty('poi-label', 'text-field', '{name_' + language + '}');
        map.setLayoutProperty('road-label', 'text-field', '{name_' + language + '}');
        map.setLayoutProperty('country-label', 'text-field', '{name_' + language + '}');
        map.setLayoutProperty('state-label', 'text-field', '{name_' + language + '}');
        map.setLayoutProperty('settlement-label', 'text-field', '{name_' + language + '}');
        map.setLayoutProperty('settlement-subdivision-label', 'text-field', '{name_' + language + '}');
        map.setLayoutProperty('airport-label', 'text-field', '{name_' + language + '}');
        map.setLayoutProperty('transit-label', 'text-field', '{name_' + language + '}');
    } catch (error) {
        console.log('err')
    }    
}
